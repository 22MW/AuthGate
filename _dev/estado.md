...
Release `1.2.3` en preparación desde `mishaAuthDev` para actualizar metadatos y compatibilidad declarada.
...
- Preparación de release estable `1.2.3`.
...
- Publicar release estable `1.2.3` y verificar ZIP/GitHub release.
